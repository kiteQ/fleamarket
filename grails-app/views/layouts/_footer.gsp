	...
	<div class="container">
		<div class="row">
			<div class="span2">
				...
				<ul class="unstyled">
					<li>
			    		<g:each in="${de.nextcommerce.core.Category.list()}" status="i" var="category">
							<li>
								<g:link controller="productShop" id="${category.id}" action="categories"><g:message code="${category.name}"/></g:link>	
							</li>
						</g:each>
					</li>
				</ul>
